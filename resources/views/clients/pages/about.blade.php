...
</p><a class="btn btn-accent btn-shadow" href="#">Chi tiết vận chuyển</a>
            </div>
          </div>
        </section>
        <!-- Row: Mobile app-->
...
Chào mừng bạn đến với kỷ nguyên mua sắm mới – tiện lợi, nhanh chóng và dành riêng cho bạn.</p><a class="btn-market btn-apple me-3 mb-3" href="#" role="button"><span class="btn-market-subtitle">Tải về ngay</span><span class="btn-market-title">App Store</span></a><a class="btn-market btn-google mb-3" href="#" role="button"><span class="btn-market-subtitle">Tải về ngay</span><span class="btn-market-title">Google Play</span></a>
        ...
        <section class="row g-0">
          <div class="col-md-6 bg-position-center bg-size-cover bg-secondary order-md-2" style="min-height: 15rem; background-image: url({{ asset('assets/clients/img/about/04.jpg') }});"></div>
          <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
            <div class="mx-auto py-lg-5" style="max-width: 35rem;">
...
Sự có mặt của chúng tôi từ Bắc vào Nam chính là minh chứng cho sự tin tưởng của hàng triệu khách hàng và là nền tảng để chúng tôi tiếp tục phát triển, phục vụ bạn ngày một tốt hơn.</p><a class="btn btn-warning btn-shadow" href="contacts.html">Liên hệ ngay</a>
            </div>
          </div>
        </section>
        <hr>
