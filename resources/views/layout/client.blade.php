...
<head>
  ...
  <link rel="stylesheet" media="screen"
    href="{{ asset('assets/clients/vendor/drift-zoom/dist/drift-basic.min.css') }}" />
  <link rel="stylesheet" media="screen"
    href="{{ asset('assets/clients/vendor/lightgallery/css/lightgallery-bundle.min.css') }}" />
  ...
  <link href="https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,400;0,700;1,400&display=swap"
    rel="stylesheet">
